...
- Priority 1 when object creation is the problem: `subagents/creational-pattern-agent.md`
- Priority 1 when object collaboration or interface shape is the problem: `subagents/structural-pattern-agent.md`
- Priority 1 when behavior variation or workflow decision is the problem: `subagents/behavioral-pattern-agent.md`
- Priority 1 when application boundary or distributed flow is the problem: `subagents/architectural-pattern-agent.md`
