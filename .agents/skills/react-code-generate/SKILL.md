...
- `subagents/react-figma-generate.md`: implement UI from Figma, screenshots, or visual requirements.
- `subagents/react-composition-design.md`: establish visual thesis, content hierarchy, imagery, copy, and motion before coding.
- `subagents/react-api-generate.md`: integrate API contracts, curl examples, and typed/request helpers.
- `subagents/react-state-form-generate.md`: handle React state, forms, validation, loading, empty, error, and success states.
- `subagents/react-accessibility-review.md`: review keyboard, semantic, responsive, and text-fit behavior.
- `subagents/react-performance-review.md`: review rendering, bundle, dependency, and build risk.
- `subagents/react-handoff-write.md`: prepare Notion/Slack/ticket completion payloads.
