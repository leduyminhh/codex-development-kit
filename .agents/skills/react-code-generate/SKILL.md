...
- [resources/figma-ui-implementation.md](resources/figma-ui-implementation.md): translate Figma or screenshots into React UI with responsive fidelity.
...
- [subagents/react-accessibility-review.md](subagents/react-accessibility-review.md): review keyboard, semantic, responsive, and text-fit behavior.
- [subagents/react-performance-review.md](subagents/react-performance-review.md): review rendering, bundle, dependency, and build risk.
- [subagents/react-handoff-write.md](subagents/react-handoff-write.md): prepare Notion/Slack/ticket completion payloads.

## Operating Mode

1. Understand the product task, target route/component, and user workflow.
2. Load [resources/frontend-composition-guidelines.md](resources/frontend-composition-guidelines.md) when the task has visible UI, layout, visual hierarchy, page design, app surface, or motion.
