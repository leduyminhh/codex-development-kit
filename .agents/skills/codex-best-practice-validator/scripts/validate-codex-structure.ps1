...
function Get-AgentRegistrationSummary {
    ...
    switch ($AgentName) {
        'codex-structure-validator' { return 'Structure validator agent' }
        'automation-testing' { return 'Test automation agent' }
        'design-pattern' { return 'Design pattern agent' }
        'diagram-w' { return 'PlantUML diagram agent' }
        'documentation-writer' { return 'Documentation writer agent' }
        'git-workflow' { return 'Git workflow agent' }
        'java-architect' { return 'Java architecture agent' }
        'qa-reviewer' { return 'QA reviewer agent' }
        'react-js' { return 'React implementation agent' }
...
remainingDays = 30
format = "text"
hook = ".codex/hooks/agent-execution-audit.ps1"
