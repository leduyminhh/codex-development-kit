...
$onionRoot = Join-Path $Root 'skills/architecture-onion-design'
$sharedRoot = Join-Path $Root 'skills/code-shared-design'
$javaSkill = Join-Path $Root 'skills/java-analyze/SKILL.md'
...
Assert-FileContains -Path $javaSkill -Pattern 'architecture-onion-design' 'Java architect skill must support forcing architecture-onion-design.'
Assert-FileContains -Path $javaSkill -Pattern 'code-shared-design' 'Java architect skill must support shared module architecture.'
Assert-FileContains -Path $javaAgent -Pattern 'architecture-onion-design' 'Java architect agent must route explicit onion requests to architecture-onion-design.'
Assert-FileContains -Path $javaAgent -Pattern 'code-shared-design' 'Java architect agent must route shared module requests.'
